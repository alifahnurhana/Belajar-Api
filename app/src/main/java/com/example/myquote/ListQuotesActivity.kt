...
import com.example.myquote.databinding.ActivityListQuetesBinding
...
class ListQuotesActivity : AppCompatActivity() {
    ...
    private lateinit var binding: ActivityListQuetesBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityListQuetesBinding.inflate(layoutInflater)
